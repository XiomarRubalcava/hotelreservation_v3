...
/***************************************************************
 *  ROOMS PAGE — DATE SETUP WHEN PAGE LOADS
 ***************************************************************/
document.addEventListener("DOMContentLoaded", () => {
...
/***************************************************************
 *  ROOMS PAGE FUNCTIONS — SEARCH, RENDER, PLACEHOLDER IMAGES
 ***************************************************************/
...
function getRoomImage(room) {
  switch (room.room_number) {
    ...
    case "102":
      return "images/double1.jpg";
    case "201":
      return "images/Queen1.jpg";
    case "202":
      return "images/King1.jpg";
    case "301":
      return "images/deluxe1.jpg";
    default:
      return "images/basic1.jpg";
  }
}
...
// Fallback sample rooms (used if API fails)
...
/***************************************************************
 *  RESERVATIONS PAGE — LOAD USER RESERVATIONS
 ***************************************************************/
async function loadUserReservations() {
  ...
  try {
    ...
    if (!res.ok || !data.reservations?.length) {
    ...
    tableBody.innerHTML = "<tr><td colspan='6'>Error loading reservations.</td></tr>";
  }
}
